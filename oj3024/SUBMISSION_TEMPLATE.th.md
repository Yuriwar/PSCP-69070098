...
```text
โจทย์ให้รับคะแนนรวมของผู้โหวตทั้งหมด และคะแนนที่มากที่สุด จากนั้นตรวจสอบว่าคะแนนที่น้อยที่สุดที่เป็นไปได้ทำให้คะแนนสูงสุดกับคะแนนต่ำสุดต่างกันเกิน 2 ไหม แล้วแสดงผลว่า Surprising หรือ Not surprising
```
...
```text
Step 1: รับค่าคะแนนรวมและคะแนนมากสุด
Step 2: คำนวณหาคะแนนต่ำสุดที่เป็นไปได้ โดยกำหนดว่า มีคนได้คะแนนมากที่สุดเท่ากัน 2 คน
Step 3: ถ้าคะแนนต่ำสุดน้อยกว่า 0 ปรับให้เป็น 0
Step 4: เปรียบเทียบคะแนนสูงสุดกับต่ำสุด แล้วแสดงผลตามเงื่อนไข
```
...
```text
เหมือนกัน เพราะใช้การคำนวณหาคะแนนต่ำสุดที่เป็นไปได้แล้วนำมาเปรียบเทียบกับคะแนนสูงสุดตามเงื่อนไขของโจทย์
```
...
```text
กรณีถ้าทำตามแล้วคะแนนต่ำสุดติดลบ โปรแกรมต้องปรับเป็น 0
```
