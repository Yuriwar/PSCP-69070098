...
```text
โจทย์ให้รับค่าเดือน กับวันที่มา เพื่อหาว่า เป็นฤดูอะไรโดยให้เงื่อนไขมา ซึ่งมีเงื่อนไขเพิ่มเติมคือ ถ้าเดือนนั้นหารด้วย 3 ลงตัว ตั้งแต่วันที่ 21 เป็นต้นไป จะเปลี่ยนฤดูไปอันถัดไป
```
...
```text
Step 1: รับค่าเดือน วันที่
Step 2: เช็คว่าเดือนที่ได้มาอยู่ใน list ไหน ได้ฤดูอะไร
Step 3: ค่อยมาเช็คเงื่อนไขเพิ่มเติม 
```
...
```text
รับค่าเดือน วันที่ มา จากนั้นสร้างตัวแปรมาเก็บลิสต์ ว่ามีฤดูอะไรบ้างเรียงลำดับอันไหนมาก่อนหลัง แล้วมาคำนวณว่าเดือนนั้นอยู่ฤดูไหน โดยใช้ (เดือน - 1 // 3) (Index เริ่มที่ 0 เลยต้อง -1) แล้วก็ใส่เงื่อนไขว่าถ้าเดือนนั้นหารสามลงตัวและวันที่ มากกว่า 20 ต้องบวกไปหนึ่งฤดู แต่มีโอกาสที่จะหลุดออกจากลิสต์เลยใช้ % 4 เพื่อให้มันวนอยู่แค่ในลิสต์
```
...
```text
ทดสอบกรณีที่เดือนหารด้วยสามลงตัวแต่วันที่ยังไม่ตรงเงื่อนไข
```
...
```text
ทดสอบกรณีเข้าเงื่อนไข และตรวจสอบว่า index วนกลับมาที่ตำแหน่งแรกของลิสต์ได้ถูกต้อง
```
