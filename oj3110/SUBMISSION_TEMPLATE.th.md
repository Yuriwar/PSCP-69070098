...
```text
โจทย์ให้คำนวณค่าธรรมเนียมส่งพัสดุ โดยรับสถานีต้นทาง ปลายทาง และน้ำหนัก โดยมีการคำนวณคือ ค่าธรรมเนียมเริ่มต้น + (น้ำหนัก * ค่าธรรมเนียมต่อกิโลกรัม) โดยมีตารางค่าธรรมเนียมให้ดู
input ต้นทาง ปลายทาง ตัวพิมพ์ใหญ่
      น้ำหนักพัสดุ
output ค่าธรรมเนียม แสดงผลจุดทศนิยม 2 ตำแหน่ง หากเส้นทางไม่อยู่ในตารางแสดงผล error
```
...
```text
Step 1: รับพิกัดต้นทางปลายทาง split แยกเก็บตัวแปร
Step 2: รับน้ำหนัก weight เป็น float
Step 3: ใช้ if-elif หาคู่ของสถานีต้นทาง ปลายทาง
Step 4: แต่ละเงื่อนไข คำนวณราคาตามสูตร แล้วสั่ง print format ทศนิยม 2 ตำแหน่ง
Step 5: หากไม่ครงเส้นทางไหนเลย เข้า else แสดงผล Error
```
...
```text
วิธีสุดท้ายใช้ตรงกับแผนแรกเพราะโจทย์เป็นการใช้ if elif อย่างตรงไปตรงมา
```
...
```text
เส้นทางปกติ มีในตาราง น้ำหนักเป็นจำนวนจริง
```
...
```text
เส้นทางปกติ มีในตาราง น้ำหนักเป็นจำนวนเต็ม
```
