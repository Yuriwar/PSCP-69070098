...
```text
โจทย์ให้รับข้อความจากนั้นนับจำนวนสระภาษาอังกฤษ ที่ปรากฏในข้อความโดยไม่สนตัวพิมพ์เล็กหรือพิมพ์ใหญ่ แล้วแสดงเฉพาะสระที่พบพร้อมจำนวนครั้ง
```
...
```text
Step 1: รับข้อความแปลงเป็นพิมพ์เล็กให้หมด
Step 2: วนลูปตรวจสอบสระ a e i o u
Step 3: นับจำนวนสระแต่ละตัว แล้วแสดงผลแค่สระที่มีมากกว่า 0
```
...
```text
เหมือนกัน เพราะใช้การแปลงข้อความเป็นตัวพิมพ์เล็กก่อน แล้ววนลูปนับจำนวนสระแต่ละตัวและแสดงผลเฉพาะสระที่พบ
```
