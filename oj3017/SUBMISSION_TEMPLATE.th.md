...
```text
รับค่า 1 บรรทัด เป็นราคาอาหาร+น้ำ
คิดค่าบริการ 10% โดยไม่ต่ำกว่า 50 บาทและไม่เกิน 1000 บาท
เอาค่าอาหาร + น้ำ + บริการ มาคิด Vat 7% 
แสดงผลเป็นราคาสุทธิ ทศนิยม 2 ตำแหน่ง
```
...
```text
Step 1: รับค่าอาหาร น้ำ เป็น int
Step 2: คำนวณ ค่าบริการ แล้วใช้ if เช็กว่าถ้าต่ำกว่า 50 ให้ปรับเป็น 50 ถ้าเกิน 1000 ปรับเป็น 1000
Step 3: เอาราคาอาหาร น้ำ + ค่าบริการ แล้วคิด Vat 7% 
Step 4: นำราคาทั้งหมดรวมกัน แสดงผลออกมาเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
เหมือนกับแผนแรก เพราะหลักการคิดเป็นขั้นตรงไปตรงมาตามเงื่อนไขโจทย์
```
...
```text
กรณีราคาอาหารน้อย เช็คว่าค่าบริการขั้นต่ำถูกไหม
```
...
```text
กรณีราคาอาหารปกติ ค่าบริการไม่น้อยกว่าขั้นต่ำหรือมากกว่าสูงสุด
```
...
```text
กรณีค่าอาหารสูง เช็คว่าค่าบริการถูกจำกัดที่ 1000 ไหม
```
