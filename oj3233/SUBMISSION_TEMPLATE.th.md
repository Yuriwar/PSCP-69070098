...
```text
ให้หาเงินรางวัลหวยที่ได้รับมากที่สุด โดยเปรียบเทียบระหว่างหวยที่ออก กับหวยที่เราซื้อ
Input:  ตัวอักษรและเลขหวยที่ออก (win_char, win_num)
        ตัวอักษรและเลขหวยของเรา (my_char, my_num)
Output: จำนวนเงินรางวัลที่ได้มากที่สุดเพียงรางวัลเดียว(หากไม่ถูกรางวัลเลยให้แสดง 0)
```
...
```text
Step 1: รับค่า เลขและตัวอักษรที่ถูก เลขของเราและตัวอักษรของเราแยกบรรทัดกัน
Step 2: สร้างลิสต์ prize เก็บรางวัลที่ได้รับ
Step 3: ใช้ if เช็คทีละเงื่อนไขของรางวัลต่าง ๆ หากตรงเงื่อนไขให้ append เงินรางวัล เข้าลิสต์ 
Step 4: ใช้ max(prize) หาเงินรางวัลที่สูงที่สุด แล้วแสดงผลออกมา
```
...
```text
เหมือนกับแผนแรกที่คิดไว้ โดยใช้วิธีเก็บค่าเงินรางวัลทั้งหมดลงในลิสต์ prize แล้วใช้ฟังก์ชัน max(prize) ดึงค่าเงินรางวัลที่มากที่สุดออกมาแสดงผล
```
...
```text
กรณีถูกเลข 2 ตัวท้าย แต่ตัวอักษรไม่ตรง
```
