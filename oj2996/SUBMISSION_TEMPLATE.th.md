...
```text
รับ input มาเป็๋นตัวหนังสือภาษาอังกฤษยาวจำนวน 5 ตัวอักษร จากนั้นแสดงค่าออกมาเป็น ตัวหนังสือเวอร์ชันย้อนกลับโดยที่ต้องเป็นตัวพิมพ์เล็กทั้งหมด
```
...
```text
Step 1: รับค่า text ทำให้เป็นพิมพ์เล็ก
Step 2: Print ออกมาโดยใช้ ::-1
```
...
```text
เหมือนกัน เพราะว่าเป็นคำสั่งพื้นฐานง่าย ๆ ในการพิมพ์ย้อนกลับ
```
...
```text
เป็นข้อความตัวหนังสือพิมพ์เล็กทั้งหมด มีความยาว 5 ตัวตามโจทย์
```
...
```text
มีตัวใดตัวหนึ่งเป็นพิมพ์ใหญ่ มีความยาว 5 ตัวตามโจทย์
```
...
```text
มีตัวพิมพ์ใหญ่ปะปนระหว่างข้อความ มีความยาว 5 ตัวตามโจทย์
```
