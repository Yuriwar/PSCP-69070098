...
```text
รับ input 2 บรรทัดเป็นชื่อสีภาษาอังกฤษ
แสดงผล ชื่อสีที่ได้จากการผสมแม่สี 2 สีนั้น ขึ้นต้นด้วยพิมพ์ใหญ่
* หากเป็นแม่สีเดียวกันผสมกัน แสดงผลเป็นชื่อแม่สีนั้นได้เลย
* หากไม่ใช่แม่สี แสดงผล error
```
...
```text
Step 1: รับค่าสีภาษาอังกฤษ 2 บรรทัด แล้วแปลงเป็นพิมพ์เล็ก
Step 2: ตั้งเงื่อนไขเช็คคู่ผสม เช่น red กับ blue หรือ blue กับ red ให้แสดงผล Violet ถ้าเป็นแม่สีเดียวกันให้แสดงผลสีนั้น
Step 3: ถ้าไม่ตรงเงื่อนไขให้แสดง error
```
...
```text
คล้ายกับแผนแรก แต่ใช้การ sorted() นำสีมาเรียงลำดับตัวอักษรในลิสต์ก่อน จะได้ไม่ต้องเขียนเงื่อนไขซ้ำซ้อนเวลาสีสลับที่กัน 
```
...
```text
ผสมแม่สีต่างกันสองสี มีพิมพ์เล็กและพิมพ์ใหญ่ปนอยู่
```
...
```text
ผสมแม่สีสีเดียวกัน มีการปนพิมพ์เล็ก-ใหญ่
```
