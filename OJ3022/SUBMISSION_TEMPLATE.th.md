...
```text
โจทย์ให้รับค่าอุณหภูมิ และหน่วยของอุณหภูมิในบรรทัด 1 จากนั้นรับว่าต้องการแปลงเป็นหน่วยอะไร
```
...
```text
Step 1: รับค่า อุณหภูมิ หน่วยอุณหภูมิ และหน่วยที่ต้องการแปลง
Step 2: เอาอุณหภูมิและหน่วยของมัน มาแปลงเป็น เซลเซียสก่อนเพื่อง่ายต่อการคำนวณ
Step 3: เช็คว่าต้องการหน่วยอะไร และคำนวณตามสูตรที่ได้มา
```
...
```text
เหมือนกัน เพราะโจทย์เป็นโลจิกที่เข้าใจง่ายตรงไปตรงมา
```
...
```text
ทดสอบแปลงเซลเซียสไปเป็นฟาเรนไฮต์ พื้นฐาน
```
...
```text
ทดสอบว่าแปลงไปกลับเป็นเซลเซียสถูกต้อง
```
...
```text
ทดสอบการแปลงจาก Rankine ไปเป็น Kelvin ที่ต้องแปลงผ่าน Celsius ก่อน เพื่อตรวจสอบว่าการคำนวณหลายขั้นตอนถูก
```
