...
```text
รับค่า พื้นที่ที่หมึกจะชยายต่อหนึ่งวิ และจำนวนคน หรือ input ที่ต้องรับค่าพิกัดของคนเขียนคำร้อง จากนั้นให้คำนวณว่าอีกกี่วิบ้านคนนั้นจะโดนน้ำท่วม โดยให้ปัดเลขขึ้นเป็นจำนวนเต็มหากเป็นทศนิยม
```
...
```text
Step 1:รับค่าพื้นที่การขยายต่อวินาที (S) และจำนวนคน (N) จากบรรทัดแรก
Step 2: วนลูปตามจพนวนคน N รับพิกัด (x,y) ของแต่ละคน
Step 3: หาพื้นที่วงกลมจากพิกัด
Step 4: คำนวณเวลาเอา AREA / S แล้วใช้ math.ceil() ปัดเศษขึ้นเสมอ จากนั้นแสดงผลลัพธ์
```
...
```text
เหมือนแผนแรก เพราะโจทย์คำนวณตรง ๆ ตามคณิตศาสตร์ โดยใช้สูตรหาพื้นที่วงกลม ซึ่งระยะทางยกกำลังสองจากจุดศูนย์กลาง ไปยังพิกัด (x,y) คือ r² = x² + y² จากนั้นหารด้วย S เพื่อหาเวลา
```
...
```text
ทดสอบกรณีทั่วไปที่หมึกขยายตัวพอดีลงตัว ไม่ต้องปัดเศษทศนิยม
```
...
```text
กรณีได้คำตอบเป็นทศนิยม เพื่อดูว่าปัดเศษถูกไหม
```
