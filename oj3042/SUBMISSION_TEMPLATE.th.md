...
หาตัวเลขตั้งแต่ N ลดลงไปหา 0 ว่าตัวไหนหารด้วย 10 ลงตัว แสดงผลเลขนั้นในบรรทัดเดียว เว้นวรรคด้วย
```
...
Step 2: ใช้ while loop ถอยหลังเลขตั้งแต่ N ถึง 0
Step 3: เช็คเงื่อนไขว่าตัวเลขนั้นหารด้วย 10 ลงตัวไหม โดยการหารเอาเศษ ถ้าหารด้วย 10 เศษ 0 แสดงว่าลงตัว
Step 4: แสดงผลเลขนั้นออกมา ใช้ end=" " เพื่อไม่ให้ขึ้นบรรทัดใหม่
```
...
```text
เหมือนกัน แต่ตรงเงื่อนไขเช็กการหารลงตัว ใช้เขียนเป็น if not N % 10 แทนการใช้ == 0 ซึ่งให้ผลลัพธ์เหมือนกัน และถูกหลัก PEP-8 เพราะว่าลอจิกโจทย์ตรงไปตรงมา
```
...
```text
N เป็นเลขที่หารด้วย 10 ลงตัวพอดี
```
