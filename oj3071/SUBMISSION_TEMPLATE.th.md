...
```text
โจทย์ให้รับว่าเริ่มที่เลขไหน สิ้นสุดเลขไหน จากนั้นให้หาว่าในช่วงจำนวนที่ให้มานั้น มีกี่จำนวนที่หารด้วย d แล้วเหลือ เศษ r
```
...
```text
Step 1: รับค่าเลขเริ่ม เลขสิ้นสุด ตัวหาร เศษที่ต้องการ
Step 2: วนลูปตั้งแต่ A ถึง B
Step 3: ตรวจสอบว่าเลขแต่ละตัวหารด้วย d แล้วเหลือเศษ r หรือไม่ ถ้าตรงก็นับเพิ่ม 1
```
...
```text
เหมือนกัน เพราะโจทย์เข้าใจง่ายตรงไปตรงมา จึงใช้หลักการที่คิดไว้
```
...
```text
ทดสอบกรณีไม่มีจำนวนใดเลยที่ตรงเงื่อนไข
```
