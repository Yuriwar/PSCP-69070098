...
```text
โจทย์ให้หาจำนวนการทุบกำแพงที่น้อยที่สุด เพื่อเดินทางไปหมายเลข 1 จากค่า N ที่รับมา
```
...
```text
Step 1: วนลูปเลขทีละแถวเพื่อหาว่า ค่า n ที่รับมา อยู่ในแถวที่เท่าไหร่ (row)
Step 2: จากนั้นหาว่าเลขแรกของแถวนั้นคือเท่าไหร่ แล้ว n เป็นเลขลำดับที่เท่าไหร่ของแถว
Step 3: เช็คว่าลำดับนั้นเป็นเลขคู่หรือคี่แล้วนำเข้าสูตรคำนวณหาผลลัพธ์
```
...
```text
วิธีสุดท้ายที่ใช้จริงตรงกับแผนแรก เพราะเป็นการคำนวณหารูปแบบ (Pattern) ของแถวและตำแหน่งแบบตรงไปตรงมา
```
...
```text
กรณีเลขนั้นอยู่ในตำแหน่งคี่ของแถว
```
...
```text
กรณีเลขนั้นอยู่ในตำแหน่งคู่ของแถว 
```
