...
```text
โจทย์ต้องการให้คำนวณคะแนนรวมสะสมจากการเล่นเกม โดยรับจำนวนรอบค่าที่ต้องรับมาก่อน หากเป็นเครื่องหมาย + เพิ่ม 10 คะแนน
เครื่องหมาย - ลด 5 คะแนน
output คะแนนรวม
```
...
```text
Step 1: รับค่า n จำนวนรอบลูป
Step 2: กำหนดค่าตัวแปร score = 0 เพื่อใช้เก็บสะสมคะแนน
Step 3: for loop แล้วใช้ if elif เช็คว่าเป็น "+" หรือ "-" เพิ่มลดคะแนนตามเงื่อนไข
Step 4: ปรินท์ค่า score ออกมา
```
...
```text
เหมือนกับแผนแรก เพราะโจทย์แค่รับสัญลักษณ์มาเพิ่มลดค่าคะแนนสะสม
```
