...
```text
โจทย์จำลองการส่งของขวัญเป็นวงกลมจำนวน N คน เริ่มจากคนที่ 1 และข้ามไปทีละ K คน และมีโจรอยู่ที่ตำแหน่ง T ให้หาว่า จะมีคนได้ถือของขวัญกี่คนก่อนที่โจรจะได้ของขวัญไป หรือเมื่อของขวัญวนกลับมาหาคนที่ 1
```
...
```text
Step 1: รับค่า N K T ตั้งค่าเริ่มต้น current = 1 และ count = 1
Step 2: เช็คกรณีโจรอยู่คนที่ 1 ตอบ 1 ได้ทันที
Step 3: วนลูปเปลี่ยนตำแหน่งคนถัดไป (current + k -1)% N+1 เพื่อให้วนอยู่ในวงกลม และบวก count ครั้งละ 1
Step 4: ในทุกรอบถ้า current ตรงกับ T ให้พิมพ์ count แล้วหยุดการทำงาน
Step 5: ถ้าวนกลับมาที่ คนที่ 1 ก่อน แสดงว่า T ไม่ได้รับของขวัญ ให้พิมพ์ count - 1 แทนแล้วหยุดทำงาน
```
...
```text
เหมือนกับแผนแรก เพราะการจำลองการวนในวงกลม เช็คตำแหน่งว่าตรงไหม
```
